        ...
        {isHydrated && leader && (
          <div className="flex w-full flex-col items-center gap-8">
            <div className="flex flex-col items-center gap-4">
              ...
              <div className="flex h-[min(75vh,75vw)] w-[min(75vh,75vw)] items-center justify-center">
                <div className="flex h-full w-full items-center justify-center rounded-[3rem] bg-gradient-to-b from-teal-500/25 via-teal-500/10 to-transparent text-[clamp(8rem,24vw,28rem)] font-bold leading-none text-teal-100 shadow-inner">
                  {leader.lapsRemaining}
                </div>
              </div>
            </div>

            <div className="flex flex-col items-center gap-3 text-xs uppercase tracking-[0.3rem] text-zinc-400">
              {!isConnected && (
